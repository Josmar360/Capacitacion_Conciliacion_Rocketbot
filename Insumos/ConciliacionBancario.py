def generar_conciliacion_bancaria():
    import pandas as pd

    # ============================
    # RUTAS DE ARCHIVOS
    # ============================
    archivo_auxiliar = "{str_ArchivoAuxiliar}"
    archivo_banco = "{str_ArchivoBanco}"
    archivo_salida = "{str_RutaConciliacion}"
